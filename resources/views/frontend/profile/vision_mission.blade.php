        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="text-2xl font-bold mb-4 text-desa-brown" data-aos="fade-down">Visi Desa Jatinagara:</h3>
                    ...
                    <h3 class="text-2xl font-bold mb-4 text-desa-brown mt-8" data-aos="fade-down">Misi Desa Jatinagara:
                    </h3>
