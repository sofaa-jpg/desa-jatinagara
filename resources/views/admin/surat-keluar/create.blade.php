            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg transition-colors duration-300">
                <div class="p-6 text-gray-900 dark:text-gray-100 transition-colors duration-300">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Surat Keluar</h1>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Tambahkan surat keluar baru ke arsip</p>
                        </div>
                    ...
                    <!-- Form -->
                    <form action="{{ route('admin.surat-keluar.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_tujuan" id="alamat_tujuan" value="{{ old('alamat_tujuan') }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_kirim" id="tanggal_kirim" value="{{ old('tanggal_kirim') }}"
                        ...
                        <div>
                            ...
                            <select name="status_kirim" id="status_kirim" required
                                ...
                                <option value="Draft" {{ old('status_kirim', 'Draft') == 'Draft' ? 'selected' : '' }}>Draft</option>
                                <option value="Dikirim" {{ old('status_kirim') == 'Dikirim' ? 'selected' : '' }}>Dikirim</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="penandatangan" id="penandatangan" value="{{ old('penandatangan') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="tembusan" id="tembusan" value="{{ old('tembusan') }}"
                ...
                <div>
                    ...
                    <textarea name="isi_ringkas" id="isi_ringkas" rows="4"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-green-500 focus:ring-green-500 @error('isi_ringkas') border-red-500 @enderror">{{ old('isi_ringkas') }}</textarea>
                    @error('isi_ringkas')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-green-500 focus:ring-green-500 @error('catatan') border-red-500 @enderror">{{ old('catatan') }}</textarea>
                    @error('catatan')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
