            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg transition-colors duration-300">
                <div class="p-6 text-gray-900 dark:text-gray-100 transition-colors duration-300">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Surat Masuk</h1>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Kelola surat masuk desa</p>
                        </div>
                    ...
                    <!-- Filter & Search -->
                    <form method="GET" action="{{ route('admin.surat-masuk.index') }}" class="mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <!-- Status Disposisi -->
                            <div>
                                <label for="status_disposisi" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Status Disposisi</label>
                                <select name="status_disposisi" id="status_disposisi" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="flex space-x-3 mt-4">
                            ...
                            <a href="{{ route('admin.surat-masuk.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-700 px-4 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
                                🔄 Reset
                            </a>
                        </div>
                    </form>
                    ...
                    <!-- Informasi hasil -->
                    @if(request()->hasAny(['search', 'jenis_surat_id', 'sifat_surat', 'status_disposisi', 'tanggal_mulai', 'tanggal_selesai']))
                        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-md p-4 mb-6">
                            <p class="text-blue-700 dark:text-blue-300 text-sm">
                                📊 Menampilkan {{ $suratMasuk->total() }} dari {{ $suratMasuk->total() }} surat masuk
                                @if(request('search'))
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden">
                                    ...
                                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                @if($surat->alamat_pengirim)
                                                    <div class="text-xs text-gray-400 dark:text-gray-500">
                                                        {{ Str::limit($surat->alamat_pengirim, 50) }}
                                                    </div>
                                                @endif
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                                    @if($surat->status_disposisi === 'Belum') bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300
                                                    @elseif($surat->status_disposisi === 'Sudah') bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div class="flex justify-end space-x-2">
                                                    ...
                                                    <button data-action="update-disposisi" data-id="{{ $surat->id }}"
                                                            class="text-blue-600 hover:text-blue-500 dark:text-blue-400" title="Update Disposisi">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            <div class="px-6 py-12 text-center">
                                ...
                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Tidak ada surat masuk</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Mulai dengan menambahkan surat masuk pertama.</p>
                                <div class="mt-6">
                                    <a href="{{ route('admin.surat-masuk.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
        ...
        <div class="mt-3">
            ...
            <form id="disposisiForm" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" id="disposisi_kepada_modal"
                           class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                </div>
...
window.closeDisposisiModal = function() {
...
document.getElementById('disposisiForm').addEventListener('submit', function(e) {
    ...
    fetch(`/admin/surat-masuk/${currentSuratId}/disposisi`, {
        method: 'POST',
        body: formData,
        headers: {
    ...
    .catch(error => {
        ...
        alert('Terjadi kesalahan saat mengupdate disposisi: ' + error.message);
    });
});
