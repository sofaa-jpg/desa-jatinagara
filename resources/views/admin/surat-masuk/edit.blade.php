            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg transition-colors duration-300">
                <div class="p-6 text-gray-900 dark:text-gray-100 transition-colors duration-300">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Surat Masuk</h1>
                            <p class="text-gray-600 dark:text-gray-400 mt-1">Edit data surat masuk: {{ $suratMasuk->nomor_surat }}</p>
                        </div>
                        <div class="flex space-x-3">
                            <a href="{{ route('admin.surat-masuk.show', $suratMasuk) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
                                👁 Lihat
                            </a>
                    ...
                    <!-- Form -->
                    <form action="{{ route('admin.surat-masuk.update', $suratMasuk) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="flex">
                                <select name="jenis_surat_id" id="jenis_surat_id" required
                                    ...
                                    @foreach($jenisSurat as $jenis)
                                        <option value="{{ $jenis->id }}" {{ old('jenis_surat_id', $suratMasuk->jenis_surat_id) == $jenis->id ? 'selected' : '' }}>
                                            {{ $jenis->nama_jenis }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="perihal" id="perihal" value="{{ old('perihal', $suratMasuk->perihal) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" name="alamat_pengirim" id="alamat_pengirim" value="{{ old('alamat_pengirim', $suratMasuk->alamat_pengirim) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_terima" id="tanggal_terima" value="{{ old('tanggal_terima', $suratMasuk->tanggal_terima->format('Y-m-d')) }}" required
                        ...
                        <div>
                            ...
                            <select name="status_disposisi" id="status_disposisi" required
                                ...
                                <option value="Sudah" {{ old('status_disposisi', $suratMasuk->status_disposisi) == 'Sudah' ? 'selected' : '' }}>Sudah</option>
                ...
                <div>
                    ...
                    <textarea name="isi_ringkas" id="isi_ringkas" rows="4"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('isi_ringkas') border-red-500 @enderror">{{ old('isi_ringkas', $suratMasuk->isi_ringkas) }}</textarea>
                    @error('isi_ringkas')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <!-- Disposisi -->
                <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4" id="disposisiSection" style="display: {{ in_array(old('status_disposisi', $suratMasuk->status_disposisi), ['Sudah', 'Selesai']) ? 'block' : 'none' }};">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="disposisi_kepada" id="disposisi_kepada" value="{{ old('disposisi_kepada', $suratMasuk->disposisi_kepada) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_disposisi" id="tanggal_disposisi" value="{{ old('tanggal_disposisi', $suratMasuk->tanggal_disposisi ? $suratMasuk->tanggal_disposisi->format('Y-m-d') : '') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="instruksi_disposisi" id="instruksi_disposisi" rows="3"
                                      class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('instruksi_disposisi') border-red-500 @enderror">{{ old('instruksi_disposisi', $suratMasuk->instruksi_disposisi) }}</textarea>
                    ...
                    @if($suratMasuk->file_surat)
                        <div class="mt-1 mb-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-md">
                            <div class="flex items-center justify-between">
                                <span class="text-sm text-gray-600 dark:text-gray-400">File saat ini: {{ $suratMasuk->file_surat }}</span>
                                <a href="{{ route('admin.surat-masuk.download', $suratMasuk) }}" class="text-blue-600 hover:text-blue-500 dark:text-blue-400 text-sm">
                                    Download
                                </a>
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <textarea name="catatan" id="catatan" rows="3"
                              class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('catatan') border-red-500 @enderror">{{ old('catatan', $suratMasuk->catatan) }}</textarea>
                    @error('catatan')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex justify-end space-x-3 pt-6">
                    <a href="{{ route('admin.surat-masuk.show', $suratMasuk) }}" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-md text-sm font-medium transition duration-150 ease-in-out">
                        Lihat Detail
                    </a>
