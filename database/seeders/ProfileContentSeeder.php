...
class ProfileContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ProfileContent::firstOrCreate(
            ['key' => 'ketinggian'],
            [
                'title' => 'Ketinggian dari Permukaan Laut',
                'content' => '185 mdpl',
                'type' => 'text',
                'is_published' => true,
            ]
        ...
        ProfileContent::firstOrCreate(
            ['key' => 'batas_utara'],
            [
                'title' => 'Batas Wilayah Utara',
                'content' => 'Desa Sejahtera',
                'type' => 'text',
                'is_published' => true,
            ]
        );
        ...
        ProfileContent::firstOrCreate(
            ['key' => 'batas_timur'],
            [
                'title' => 'Batas Wilayah Timur',
                'content' => 'Desa Harmoni',
                'type' => 'text',
                'is_published' => true,
            ]
        );
        ...
        // --- Data Identitas & Motto ---
        ProfileContent::firstOrCreate(
            ['key' => 'motto_desa'],
            [
                'title' => 'Motto Desa',
                'content' => 'Bersatu Membangun Desa yang Mandiri dan Sejahtera',
                'type' => 'text',
                'is_published' => true,
            ]
        );
        ...
        ProfileContent::firstOrCreate(
            ...
            [
                'title' => 'Jam Operasional Sabtu',
                'content' => '08:00 - 12:00 WIB',
                'type' => 'text',
                'is_published' => true,
            ]
        );
        ...
        ProfileContent::firstOrCreate(
            ...
            [
                ...
                'content' => '1 Puskesmas, 2 Posyandu',
                'type' => 'text',
                'is_published' => true,
            ]
        );
        ...
        ProfileContent::firstOrCreate(
            ...
            [
                ...
                'content' => '3 Masjid, 1 Gereja, 1 Pura',
                'type' => 'text',
                'is_published' => true,
            ]
        );
